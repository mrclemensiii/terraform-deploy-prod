...
# Change 2 add environment variable to security group name
...
# Change 3 set ingress ports to variables defined in variables.tf
  ingress {
...
# Change 4 Force Uppercase for server name to ensure consistent look
 tags {
